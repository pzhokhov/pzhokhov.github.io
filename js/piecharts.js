...
function drawChartBuilderRecent() {
    ...
    var options = {
      title: "Build hours  in last 30 days by builder (total 19)",
      is3D: true
    };
...
function drawChartBuilder() {
    var data = google.visualization.arrayToDataTable([
      ['Builder', 'Hours'],
        ...
        [ "Sasha + Peter", 3551.2000000000007 ],
      
        [ "Joost", 168.5 ],
      
        [ "Brandon", 144.9 ],
      
        [ "Katya", 129.15000000000003 ],
    ...
    var options = {
      title: "Build hours by builder (total 4876)",
      is3D: true
    };
...
function drawChartMonth() {
    var data = google.visualization.arrayToDataTable([
      ['Month', 'All', 'Sasha + Peter'],
        ...
        [ "8/2025", 13.285714285714286, 13.285714285714286],
