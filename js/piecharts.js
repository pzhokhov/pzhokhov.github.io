...
function drawChartBuilderRecent() {
    var data = google.visualization.arrayToDataTable([
      ['Builder', 'Hours'],
        ...
        [ "Sasha + Peter", 62.099999999999994 ],
    ...
    var options = {
      title: "Build hours  in last 30 days by builder (total 130)",
      is3D: true
    };
...
function drawChartBuilder() {
    ...
    var options = {
      title: "Build hours by builder (total 3022)",
      is3D: true
    };
...
function drawChartMonth() {
    var data = google.visualization.arrayToDataTable([
      ['Month', 'All', 'Sasha + Peter'],
        ...
        [ "4/2023", 125.27586206896552, 54.931034482758626],
