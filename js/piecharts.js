...
function drawChartBuilder() {
    var data = google.visualization.arrayToDataTable([
      ['Builder', 'Hours'],
        ...
        [ "Peter", 414.89999999999986 ],
      
        [ "Sasha", 357.39999999999986 ],
      
        [ "Katya", 81.00000000000003 ],
    ...
    var options = {
      title: "Build hours by builder (total 961)",
      is3D: true
    };
