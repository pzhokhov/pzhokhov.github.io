...
function drawChartBuilderRecent() {
    ...
    var options = {
      title: "Build hours  in last 30 days by builder (total 108)",
      is3D: true
    };
...
function drawChartBuilder() {
    ...
    var options = {
      title: "Build hours by builder (total 4002)",
      is3D: true
    };
...
function drawChartMonth() {
    var data = google.visualization.arrayToDataTable([
      ['Month', 'All', 'Sasha + Peter'],
        ...
        [ "11/2023", 66.42857142857143, 55.714285714285715],
