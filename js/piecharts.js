...
function drawChartBuilderRecent() {
    ...
    var options = {
      title: "Build hours  in last 30 days by builder (total 107)",
      is3D: true
    };
...
function drawChartBuilder() {
    ...
    var options = {
      title: "Build hours by builder (total 4294)",
      is3D: true
    };
...
function drawChartSubkit() {
    var data = google.visualization.arrayToDataTable([
      ['Sub-kit', 'Hours'],
        ...
        [ "fuselage", 1149.1500000000005 ],
      
        [ "undercarriage", 106.85 ],
      
        [ "fwf", 551.1999999999999 ],
...
function drawChartMonth() {
    var data = google.visualization.arrayToDataTable([
      ['Month', 'All', 'Sasha + Peter'],
        ...
        [ "1/2024", 33.952380952380956, 14.761904761904763],
