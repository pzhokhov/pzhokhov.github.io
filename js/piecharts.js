...
function drawChartBuilderRecent() {
    ...
    var options = {
      title: "Build hours  in last 30 days by builder (total 128)",
      is3D: true
    };
...
function drawChartBuilder() {
    ...
    var options = {
      title: "Build hours by builder (total 4053)",
      is3D: true
    };
...
function drawChartMonth() {
    var data = google.visualization.arrayToDataTable([
      ['Month', 'All', 'Sasha + Peter'],
        ...
        [ "11/2023", 112.49999999999999, 88.63636363636363],
