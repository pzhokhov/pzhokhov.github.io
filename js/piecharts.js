...
function drawChartBuilder() {
    var data = google.visualization.arrayToDataTable([
      ['Builder', 'Hours'],
        ...
        [ "Peter", 412.89999999999986 ],
      
        [ "Sasha", 352.39999999999986 ],
      
        [ "Katya", 78.00000000000003 ],
    ...
    var options = {
      title: "Build hours by builder (total 945)",
      is3D: true
    };
