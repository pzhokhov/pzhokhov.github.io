...
function drawChartBuilderRecent() {
    ...
    var options = {
      title: "Build hours  in last 30 days by builder (total 36)",
      is3D: true
    };
...
function drawChartBuilder() {
    var data = google.visualization.arrayToDataTable([
      ['Builder', 'Hours'],
        ...
        [ "Sasha + Peter", 3494.2000000000007 ],
    ...
    var options = {
      title: "Build hours by builder (total 4797)",
      is3D: true
    };
...
function drawChartMonth() {
    var data = google.visualization.arrayToDataTable([
      ['Month', 'All', 'Sasha + Peter'],
        ...
        [ "4/2025", 23.793103448275865, 22.758620689655174],
